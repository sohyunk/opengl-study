...
float lastX = SCR_WIDTH / 2.0f;			// 마우스 처음 위치는 화면 중앙
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::vec3 diffuseColor = lightColor * glm::vec3(0.5f);		// 영향을 감소
		...
		lightingShader.setVec3("light.diffuse", diffuseColor);	// 0.5f, 0.5f, 0.5f  Scene에 맞는 어두운 빛
